    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(help_text='Content type of the model under version control.', to='contenttypes.ContentType', on_delete=models.CASCADE)),
                ('revision', models.ForeignKey(help_text='The revision that contains this version.', to='reversion.Revision', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
